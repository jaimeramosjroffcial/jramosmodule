...
use Jramos\Jramosmodule\Exceptions\InvalidAssetPath;
use Jramos\Jramosmodule\Exceptions\ModuleNotFoundException;
use Jramos\Jramosmodule\Process\Installer;
use Jramos\Jramosmodule\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param $name
     * @param $path
     * @return \Jramos\Jramosmodule\Module
     */
     ...
     * @return string
     * @throws \Jramos\Jramosmodule\Exceptions\ModuleNotFoundException
     */
